<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Emptydatatext27.aspx.cs" Inherits="GRID_PRACTICE.Emptydatatext27" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:GridView ID="GridView1" EmptyDataText="No product" runat="server" AutoGenerateColumns="False" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" DataKeyNames="ProdcutId" DataSourceID="SqlDataSource1">
                <Columns>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:GridEmployeeConnectionString %>" SelectCommand="SELECT * FROM [tblProduct]"></asp:SqlDataSource>
    </form>
</body>
</html>
